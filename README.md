...
Yêu cầu máy tính đã cài đặt Python 3.8+ và pip. Cài đặt toàn bộ thư viện phụ thuộc:
...
notebooks/07_model_audit_and_improvement.ipynb
...
R²: 0.3729 (Tăng +7.12% so với baseline cũ 0.3017).
...
CV Mean R²: 0.3665 ± 0.0387 (Đồng nhất hoàn toàn với Test Set).
...
Di chuyển vào thư mục frontend và khởi chạy máy chủ phát triển Angular:
